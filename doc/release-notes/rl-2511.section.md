...
- `debBuild`, `rpmBuild`, `mvnBuild` and `binaryTarball` in `releaseTools` have been removed.

- The `releaseTools.makeSourceTarball` alias to `sourceTarball` has been removed.

- The RPM support in `vmTools` has been removed.
